		...
		<div className="min-h-screen p-6 space-y-6">
				...
				<div className="flex items-start gap-3">
					...
					<div className="flex-1 space-y-2">
						...
						<p className="text-slate-600">
							Use Chase Freedom for your next grocery purchase to earn 5%
							cashback (ends this quarter).
						</p>
						<Button
							size="sm"
			...
			<div className="space-y-3">
				...
				{cards.map((card, index) => (
					...
					>
						<div
							className={`bg-gradient-to-br ${card.color} text-white p-4 rounded-xl mb-3`}
						>
						...
						<div className="flex items-center justify-between">
							...
							<div className="text-right">
								...
								<Button
									size="sm"
									variant="ghost"
									className="text-teal-600 dark:text-teal-400 mt-1"
								>
									Pay Now
								</Button>
							</div>
